  ...
  return (
    ...
    >
      <div className="layout-container py-16 md:py-20 lg:py-24">
        <div className="flex w-full min-w-0 flex-col gap-12 lg:grid lg:grid-cols-[minmax(0,0.45fr)_minmax(0,0.55fr)] lg:items-center lg:gap-x-12 xl:gap-x-16 min-[1440px]:grid-cols-[minmax(0,0.4fr)_minmax(0,0.6fr)] min-[1440px]:gap-x-20">
          {/* Left — copy + technology list */}
          <div className="flex w-full min-w-0 flex-col lg:max-w-[520px]">
          ...
          <div className="relative flex min-h-[min(380px,52vh)] w-full min-w-0 items-center justify-center overflow-hidden sm:min-h-[min(560px,70vh)] lg:min-h-[740px] lg:overflow-visible min-[1440px]:min-h-[820px]">
            <div className="w-full max-lg:origin-center max-lg:scale-[0.82] sm:max-lg:scale-[0.88] min-[1440px]:origin-center min-[1440px]:scale-[1.14]">
