...
const keyAdvantages = [
  {
    ...
    description:
      "Rapid workforce expansion and adjustment based on volume fluctuations.",
    icon: Users,
  },
  {
    title: "Advanced RF Testing",
    description:
      "Comprehensive device validation including function, signal, and performance testing.",
    icon: Radio,
  },
  {
    title: "3-Level Repair Capability",
    description:
      "Component-level diagnostics and restoration performed by experienced technicians.",
    icon: Layers3,
  },
  {
    title: "NEMO Workforce Platform",
    description:
      "Real-time visibility into productivity, attendance, and operational performance.",
    icon: LayoutDashboard,
  },
  {
    title: "Automation Ready Operations",
    description:
      "AMR integration and scalable workflow automation for higher efficiency.",
    icon: Bot,
  },
  {
    title: "End-to-End Fulfillment",
    description:
      "From receiving and refurbishment through packaging and outbound logistics.",
    icon: PackageCheck,
  },
] as const;
...
export default function MobileRefurbishmentIntro() {
  return (
        ...
        <div className="grid items-center gap-12 lg:grid-cols-[minmax(0,340px)_1fr] lg:gap-16">
                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="min-w-0 pt-0.5">
                          <h3 className="text-[13px] font-semibold tracking-[-0.02em] text-[#0A3A86]">
                            {item.title}
                          </h3>
                          <p className="mt-0.5 text-[11px] leading-[1.45] text-[#64748B]">
                            {item.description}
                          </p>
                        </div>
                      </div>
          ...
          <div>
            ...
            <h2 className="mt-5 max-w-[720px] text-[clamp(32px,3.2vw,52px)] font-medium leading-[1.05] tracking-[-0.04em] text-[#0B0F14]">
              Mobile Refurbishment Services
            </h2>

            <p className="mt-6 max-w-[680px] text-[17px] leading-[1.75] text-[#475569]">
              ITS delivers end-to-end refurbishment operations from receiving
              and grading through testing, repair, quality assurance, packing,
              and shipment.
            </p>

            <p className="mt-4 max-w-[680px] text-[17px] leading-[1.75] text-[#475569]">
              Advanced testing technology, standardized workflows, and workforce
              coordination help ensure consistent quality, operational
