...
export default function AutomationSolutionsHero() {
  return (
    <section
      id="hero"
      className="relative overflow-hidden bg-black pt-28 pb-14 sm:pt-32 sm:pb-16 md:pb-20 lg:min-h-[calc(100vh-80px)] lg:pt-36 lg:pb-24"
    >
      <div className="layout-container relative z-10">
        <div className="flex w-full min-w-0 flex-col gap-10 lg:grid lg:grid-cols-[45%_55%] lg:items-stretch lg:gap-8 xl:gap-10">
          <div className="flex w-full min-w-0 flex-col justify-center">
            <motion.h1
              initial={{ opacity: 0, y: 14 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.65 }}
              className="max-w-[520px] text-[clamp(28px,7vw,64px)] font-semibold leading-[1.08] tracking-[-0.04em]"
            >
          ...
          <div className="relative flex w-full min-w-0 flex-col overflow-hidden">
            <div
              ...
              aria-hidden
            />
            <div className="relative flex w-full min-h-[260px] flex-col sm:min-h-[320px] lg:min-h-[min(78vh,760px)]">
              <AutomationHeroScene />
            </div>
          </div>
        </div>
